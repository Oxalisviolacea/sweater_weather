...
RSpec.describe Background do
  it 'exists' do
    photo = { id: 'hdzGZRCYMSU',
              created_at: '2020-09-13T19:54:14-04:00',
              updated_at: '2021-01-18T01:17:15-05:00',
              promoted_at: nil,
              width: 3888,
              height: 5184,
              color: '#d9f3f3',
              ...
              urls: { raw: 'https://images.unsplash.com/photo-1600041161228-519e6dd27bac?ixid=MXwxOTk1NzV8MHwxfHNlYXJjaHwxfHxkZW52ZXIsY298ZW58MHx8fA&ixlib=rb-1.2.1',
                      full: 'https://images.unsplash.com/photo-1600041161228-519e6dd27bac?crop=entropy&cs=srgb&fm=jpg&ixid=MXwxOTk1NzV8MHwxfHNlYXJjaHwxfHxkZW52ZXIsY298ZW58MHx8fA&ixlib=rb-1.2.1&q=85',
                      regular: 'https://images.unsplash.com/photo-1600041161228-519e6dd27bac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxOTk1NzV8MHwxfHNlYXJjaHwxfHxkZW52ZXIsY298ZW58MHx8fA&ixlib=rb-1.2.1&q=80&w=1080',
                      small: 'https://images.unsplash.com/photo-1600041161228-519e6dd27bac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxOTk1NzV8MHwxfHNlYXJjaHwxfHxkZW52ZXIsY298ZW58MHx8fA&ixlib=rb-1.2.1&q=80&w=400',
                      thumb: 'https://images.unsplash.com/photo-1600041161228-519e6dd27bac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxOTk1NzV8MHwxfHNlYXJjaHwxfHxkZW52ZXIsY298ZW58MHx8fA&ixlib=rb-1.2.1&q=80&w=200' },
              ...
              user: { id: 'uMT_KSln-6U',
                      ...
                      profile_image: { small: 'https://images.unsplash.com/profile-1598778372638-601d72333823image?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&cs=tinysrgb&fit=crop&h=32&w=32',
                      ...
                      total_photos: 78,
                      accepted_tos: true },
              tags: [{ type: 'search', title: 'human' },
                     { type: 'landing_page',
                       title: 'person',
                       source: { ancestry: { type: { slug: 'images', pretty_slug: 'Images' }, category: { slug: 'people', pretty_slug: 'People' } },
                                 ...
                                 cover_photo: { id: 'PmNjS6b3XP4',
                                                ...
                                                urls: { raw: 'https://images.unsplash.com/photo-1492725764893-90b379c2b6e7?ixlib=rb-1.2.1',
                                                ...
                                                links: { self: 'https://api.unsplash.com/photos/PmNjS6b3XP4',
                                                ...
                                                user: { id: '7S_pCRiCiQo',
                                                        ...
                                                        links: { self: 'https://api.unsplash.com/users/thedakotacorbin',
                                                        ...
                                                        profile_image: { small: 'https://images.unsplash.com/profile-1593623494202-55ffc4dc725cimage?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&cs=tinysrgb&fit=crop&h=32&w=32',
                     ...
                     { type: 'landing_page',
                       title: 'nature',
                       source: { ancestry: { type: { slug: 'images', pretty_slug: 'Images' }, category: { slug: 'nature', pretty_slug: 'Nature' } },
                                 title: 'Nature Images',
                                 ...
                                 cover_photo: { id: 'VE5FRc7uiC4',
                                                ...
                                                urls: { raw: 'https://images.unsplash.com/photo-1539593395743-7da5ee10ff07?ixlib=rb-1.2.1',
                                                ...
                                                links: { self: 'https://api.unsplash.com/photos/VE5FRc7uiC4',
                                                ...
                                                user: { id: 'PvaYY7qgvqU',
                                                        ...
                                                        location: 'almelo',
                                                        links: { self: 'https://api.unsplash.com/users/akin',
                                                        ...
                                                        profile_image: { small: 'https://images.unsplash.com/profile-1578436703762-5a9ab2f10de8image?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&cs=tinysrgb&fit=crop&h=32&w=32',
    ...
    photo = Background.new(photo, location)

    expect(photo).to be_a Background
    expect(photo.location).to eq('denver,co')
    expect(photo.image_url).to eq('https://images.unsplash.com/photo-1600041161228-519e6dd27bac?ixid=MXwxOTk1NzV8MHwxfHNlYXJjaHwxfHxkZW52ZXIsY298ZW58MHx8fA&ixlib=rb-1.2.1')
    expect(photo.author).to eq('Michael Kilcoyne')
  end
end
